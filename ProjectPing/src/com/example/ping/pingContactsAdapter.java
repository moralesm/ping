...
public class pingContactsAdapter extends ArrayAdapter<Contact> {
	
	Context context; 
	int layoutResourceId;    
	Contact[] data = null;
	
	public pingContactsAdapter(Context context, int layoutResourceId, Contact[] data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(row == null)
		{
			...
			holder.txtName = (TextView)row.findViewById(R.id.pingContactName);
